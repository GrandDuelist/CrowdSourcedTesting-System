...
public class Administrator  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Administrator(String administratorName, String administratorEmail, String administratorPassword, Boolean administratorAuthority, String administratorOccupation) {
    ...
    /** full constructor */
    public Administrator(String administratorName, String administratorEmail, String administratorPassword, Boolean administratorAuthority, String administratorOccupation, Set recruitments, Set publishers, Set questionnaires) {
        this.administratorName = administratorName;
        this.administratorEmail = administratorEmail;
        this.administratorPassword = administratorPassword;
        this.administratorAuthority = administratorAuthority;
