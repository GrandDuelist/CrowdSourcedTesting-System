...
public class Questionnaire  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Questionnaire(Publisher publisher, String title, Double credit, Integer questionnaireCount) {
    ...
    /** full constructor */
    public Questionnaire(Administrator administrator, Publisher publisher, String title, Double credit, Integer questionnaireCount, Set questions, Set joinQuestionnaires) {
