...
public class Recruitment  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Recruitment(Publisher publisher, String activityName, Boolean online, Boolean recruimentType) {
    ...
    /** full constructor */
    public Recruitment(Administrator administrator, Publisher publisher, String activityName, Date timeStart, Date timeEnd, Boolean online, String content, String brief, String company, String place, Boolean recruimentType) {
