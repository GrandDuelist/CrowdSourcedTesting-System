...
public class BugReport  implements java.io.Serializable {
	...
	/** minimal constructor */
    public BugReport(TestTask testTask, Tester tester, String reportTitle, Boolean reportType, Date submitTime, String operation, Boolean isSelected) {
    ...
    /** full constructor */
    public BugReport(TestTask testTask, Tester tester, String reportTitle, Boolean reportType, Date submitTime, String picture, String operation, Byte bugLevel, String operationResult, Boolean isSelected) {
        this.testTask = testTask;
        this.tester = tester;
        this.reportTitle = reportTitle;
        this.reportType = reportType;
