...
public class Product  implements java.io.Serializable {
	...
	/** minimal constructor */
    public Product(Subcategory subcategory, Date releaseTime, String version, Boolean status, String description, String icon) {
    ...
    /** full constructor */
    public Product(Subcategory subcategory, Date releaseTime, String version, Boolean status, String description, String loginXmlFile, String icon, String apkAddress, String webLink, String desktopAddress, Set testTasks) {
        this.subcategory = subcategory;
        this.releaseTime = releaseTime;
        this.version = version;
        this.status = status;
