...
/**
 	* A data access object (DAO) providing persistence and search support for TestTask entities.
...
public class TestTaskDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TestTaskDAO.class);
		//property constants
    ...
    public TestTask findById( java.lang.Integer id) {
        ...
        try {
            TestTask instance = (TestTask) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.TestTask", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TestTask instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("cn.com.crowdsourcedtesting.DAO.TestTask")
    ...
    public TestTask merge(TestTask detachedInstance) {
        ...
        try {
            TestTask result = (TestTask) getSession()
