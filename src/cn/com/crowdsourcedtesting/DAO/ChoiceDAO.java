...
/**
 	* A data access object (DAO) providing persistence and search support for Choice entities.
...
public class ChoiceDAO extends BaseHibernateDAO  {
    ...
    public Choice findById( java.lang.Integer id) {
        ...
        try {
            Choice instance = (Choice) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.Choice", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Choice instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("cn.com.crowdsourcedtesting.DAO.Choice")
    ...
    public Choice merge(Choice detachedInstance) {
        ...
        try {
            Choice result = (Choice) getSession()
