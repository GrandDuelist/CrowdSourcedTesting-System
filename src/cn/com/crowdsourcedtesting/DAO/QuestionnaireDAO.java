...
/**
 	* A data access object (DAO) providing persistence and search support for Questionnaire entities.
...
public class QuestionnaireDAO extends BaseHibernateDAO  {
    ...
    public Questionnaire findById( java.lang.Integer id) {
        ...
        try {
            Questionnaire instance = (Questionnaire) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.Questionnaire", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Questionnaire instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("cn.com.crowdsourcedtesting.DAO.Questionnaire")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding Questionnaire instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public Questionnaire merge(Questionnaire detachedInstance) {
        ...
        try {
            Questionnaire result = (Questionnaire) getSession()
