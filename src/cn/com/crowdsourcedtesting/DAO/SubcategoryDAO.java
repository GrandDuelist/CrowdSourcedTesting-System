...
/**
 	* A data access object (DAO) providing persistence and search support for Subcategory entities.
...
public class SubcategoryDAO extends BaseHibernateDAO  {
    ...
    public Subcategory findById( java.lang.Integer id) {
        ...
        try {
            Subcategory instance = (Subcategory) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.Subcategory", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Subcategory instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("cn.com.crowdsourcedtesting.DAO.Subcategory")
    ...
    public Subcategory merge(Subcategory detachedInstance) {
        ...
        try {
            Subcategory result = (Subcategory) getSession()
