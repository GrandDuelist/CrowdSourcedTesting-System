...
/**
 	* A data access object (DAO) providing persistence and search support for JoinTask entities.
...
public class JoinTaskDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(JoinTaskDAO.class);
		//property constants
    ...
    public JoinTask findById( java.lang.Integer id) {
        ...
        try {
            JoinTask instance = (JoinTask) getSession()
                    .get("JoinTask", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public JoinTask merge(JoinTask detachedInstance) {
        ...
        try {
            JoinTask result = (JoinTask) getSession()
