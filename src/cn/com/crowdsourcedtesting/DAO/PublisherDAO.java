...
/**
 	* A data access object (DAO) providing persistence and search support for Publisher entities.
...
public class PublisherDAO extends BaseHibernateDAO  {
    ...
    public Publisher findById( java.lang.Integer id) {
        ...
        try {
            Publisher instance = (Publisher) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.Publisher", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Publisher merge(Publisher detachedInstance) {
        ...
        try {
            Publisher result = (Publisher) getSession()
