...
/**
 	* A data access object (DAO) providing persistence and search support for Tester entities.
...
public class TesterDAO extends BaseHibernateDAO  {
    ...
    public Tester findById( java.lang.Integer id) {
        ...
        try {
            Tester instance = (Tester) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.Tester", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Tester merge(Tester detachedInstance) {
        ...
        try {
            Tester result = (Tester) getSession()
