...
/**
 	* A data access object (DAO) providing persistence and search support for JoinQuestionnaire entities.
...
public class JoinQuestionnaireDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(JoinQuestionnaireDAO.class);
		//property constants
    ...
    public JoinQuestionnaire findById( java.lang.Integer id) {
        ...
        try {
            JoinQuestionnaire instance = (JoinQuestionnaire) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.JoinQuestionnaire", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(JoinQuestionnaire instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("cn.com.crowdsourcedtesting.DAO.JoinQuestionnaire")
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding JoinQuestionnaire instance with property: " + propertyName
            + ", value: " + value);
      try {
    ...
    public JoinQuestionnaire merge(JoinQuestionnaire detachedInstance) {
        ...
        try {
            JoinQuestionnaire result = (JoinQuestionnaire) getSession()
