...
/**
 	* A data access object (DAO) providing persistence and search support for BugReport entities.
...
public class BugReportDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(BugReportDAO.class);
		//property constants
    ...
    public BugReport findById( java.lang.Integer id) {
        ...
        try {
            BugReport instance = (BugReport) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.BugReport", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public BugReport merge(BugReport detachedInstance) {
        ...
        try {
            BugReport result = (BugReport) getSession()
