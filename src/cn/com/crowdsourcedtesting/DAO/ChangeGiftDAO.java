...
/**
 	* A data access object (DAO) providing persistence and search support for ChangeGift entities.
...
public class ChangeGiftDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(ChangeGiftDAO.class);
		//property constants
    ...
    public ChangeGift findById( java.lang.Integer id) {
        ...
        try {
            ChangeGift instance = (ChangeGift) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.ChangeGift", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public ChangeGift merge(ChangeGift detachedInstance) {
        ...
        try {
            ChangeGift result = (ChangeGift) getSession()
