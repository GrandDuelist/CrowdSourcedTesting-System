...
/**
 	* A data access object (DAO) providing persistence and search support for TaskComment entities.
...
public class TaskCommentDAO extends BaseHibernateDAO  {
	     private static final Logger log = LoggerFactory.getLogger(TaskCommentDAO.class);
		//property constants
    ...
    public TaskComment findById( java.lang.Integer id) {
        ...
        try {
            TaskComment instance = (TaskComment) getSession()
                    .get("cn.com.crowdsourcedtesting.DAO.TaskComment", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(TaskComment instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("cn.com.crowdsourcedtesting.DAO.TaskComment")
    ...
    public TaskComment merge(TaskComment detachedInstance) {
        ...
        try {
            TaskComment result = (TaskComment) getSession()
