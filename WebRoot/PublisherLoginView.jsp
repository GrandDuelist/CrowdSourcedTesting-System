...
<div class="container">		
	<div class="row-fluid">
        <form  action="entrance.do?method=enter" class="log-page" method="post" >
        <h3>帐号登录
        <%if(session.getAttribute("p_login")!=null&&session.getAttribute("p_login").equals("fail")){
        session.setAttribute("p_login", null);
        session.removeAttribute("p_login");
        %>
