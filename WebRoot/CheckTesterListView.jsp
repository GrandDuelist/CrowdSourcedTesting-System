...
/* try{ */
    ...
    request.removeAttribute("isLegal");
 	...
 	List<Tester> testers = (List<Tester>) request.getAttribute("testers");
...
<head>
	...
	<script type="text/javascript" src="js/list_control/admin_tester1.js"></script>
...
<!-- Plugin CSS -->
<link rel="stylesheet" type="text/css"
	href="vendor/plugins/calendar/fullcalendar.css" media="screen" />
<link rel="stylesheet" type="text/css"
	href="vendor/plugins/datatables/css/datatables.min.css" />
<link rel="stylesheet" type="text/css"
	href="vendor/editors/xeditable/css/bootstrap-editable.css" />
<link rel="stylesheet" type="text/css"
	href="vendor/plugins/chosen/chosen.min.css" />
 ...
 <input type="hidden" name="page">
	...
	<div id="main">
		...
		<aside id="sidebar">
			...
			<div id="sidebar-menu">
				<ul class="nav sidebar-nav">
					<li><a class="accordion-toggle collapsed" href="#examine"><span
							class="glyphicons glyphicons-check"></span><span
							class="sidebar-title">审核</span><span class="caret"></span> </a>
						<ul id="examine" class="nav sub-nav">
							<li><a href="checkTestTaskList.do?method=checkWebList"><span
									class="glyphicons glyphicons glyphicons-flag"></span> 审核任务</a></li>
							<li><a href="manageQuestionnaire.do?method=checkList"><span
									class="glyphicons glyphicons-list"></span> 审核问卷</a></li>
							<li><a href="checkRegisterList.do?method=checkCompanyList"><span
									class="glyphicons glyphicons-user"></span> 审核发布者帐号</a></li>
						</ul>
					</li>
					<li class="active"><a class="accordion-toggle collapsed"
						href="#user_admin"><span
							class="glyphicons glyphicons-adress_book"></span><span
							class="sidebar-title">用户管理</span><span class="caret"></span> </a>
						<ul id="user_admin" class="nav sub-nav">
							<li class="active"><a href="admin_testerlist.html"><span
									class="glyphicons glyphicons-cleaning"></span> 维护测试者信息</a></li>
							<li><a href="admin_publisherlist.html"><span
									class="glyphicons glyphicons-lightbulb"></span> 维护发布者信息</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<section id="content">
			<div id="topbar">
				<ol class="breadcrumb">
					<li><a href="admin_home.html"><i class="fa fa-home"></i> </a>
					</li>
									...
									<div class="panel-body">
										<div class="tab-content padding-none border-none">
											...
											<table class="table table-striped" id="datatable">
												...
												%>
												<tr>
														<td class="text-center"><img src="img/avatars/a2.png"
															width="50" height="50" alt="avatar" /></td>
														<td class="info"><b><%=tester.getTesterName() %></b>
														</td>
														<td><i
															class="fa fa-envelope fa-lg text-blue padding-right-sm"></i>
															<%=tester.getTesterEmail() %></td>
														<td><i
															class="fa fa-envelope fa-lg text-blue padding-right-sm"></i>
															<%=tester.getTesterMobile() %></td>
														<td><i
															class="fa fa-calendar fa-lg text-blue padding-right-sm"></i><%=tester.getTesterBirthday()==null?"未填写":tester.getTesterBirthday() %></td>
														<td id="detail" class="text-right text-center"><a
															class="btn btn-primary btn-gradient" type="button"
															id=<%=tester.getTesterId() %>><span
																class="glyphicons glyphicons-circle_info"></span> 详细 </a></td>
													</tr>
											<%	} %>
	...
	<script type="text/javascript"
		src="vendor/plugins/datatables/js/datatables.js"></script>
	<script type="text/javascript"
		src="http://cdnjs.cloudflare.com/ajax/libs/flot/0.8.1/jquery.flot.min.js"></script>
	<script type="text/javascript"
		src="http://cdnjs.cloudflare.com/ajax/libs/jquery-sparklines/2.1.2/jquery.sparkline.min.js"></script>
	<script type="text/javascript"
		src="http://ajax.aspnetcdn.com/ajax/jquery.dataTables/1.9.4/jquery.dataTables.min.js"></script>
	<script type="text/javascript"
		src="http://cdnjs.cloudflare.com/ajax/libs/fullcalendar/1.6.4/fullcalendar.min.js"></script>
...
-->
	...
	<!-- Calendar Addon -->
	<script type="text/javascript"
		src="vendor/plugins/jqueryflot/jquery.flot.resize.min.js"></script>
	<!-- Flot Charts Addon -->
	<script type="text/javascript"
		src="vendor/plugins/datatables/js/datatables.js"></script>
	<!-- Datatable Bootstrap Addon -->
	<script type="text/javascript"
		src="vendor/plugins/chosen/chosen.jquery.min.js"></script>
				...
				.ready(
						function() {
							...
							var runFlotCharts = function() {
								...
								var chartColours = [ '#62aeef', '#d8605f',
										'#72c380', '#6f7a8a', '#f7cb38',
										'#5a8022', '#2c7282' ];
							...
							// Init Datatables
							$('#datatable, #datatable_2, #datatable_3')
									.dataTable({
										"bSort" : true,
										"bPaginate" : false,
										"bLengthChange" : false,
