            ...
            <div class="col-md-12">
              <div class="panel">
                <div class="panel-heading panel-visible">
                  <div class="pull-left margin-right-sm messenger-header-actions ">
                    <i class="fa fa-comments"></i> 评论列表
                  </div>
                  <div class="pull-right">
                    <div class="btn-group">
                      <button type="button" class="btn btn-default btn-gradient dropdown-toggle" data-toggle="dropdown"> <span class="glyphicons glyphicons-cogwheel"></span> 操作</button>
                ...
                <div class="panel-menu">
                  ...
                  <button type="button" class="btn btn-danger btn-gradient"> <span class="glyphicons glyphicons-delete padding-right-sm"></span> 无效 </button>
                  <button type="button" class="btn btn-primary btn-gradient"> <span class="glyphicons glyphicons-upload padding-right-sm"></span> 设为有用 </button>
                  <div class="btn-group">
                  <button type="button" class="btn btn-warning btn-gradient dropdown-toggle" data-toggle="dropdown"> <span class="glyphicons glyphicons-star padding-right-sm"></span> 奖励 </button>
                  <ul class="dropdown-menu checkbox-persist pull-right text-left" role="menu">
                        <li><a> 50分 </a></li>
                        <li><a> 100分 </a></li>
                        <li><a> 150分 </a></li>
                ...
                <div class="panel-body">
                  <div class="email-menu">
                    <table class="table table-hover">
                      <tbody>
                        <tr>
                          <td class="email-menu-avatar"><img src="img/avatars/2.png" class="img-responsive" alt="avatar" /></td>
                          <td class="email-menu-message"><b>程冉</b><br />
                            百度云是一个备份资料的...这个任务不太好操作</td>
                          <td class="email-menu-date"> 05/14/13 </td>
                        </tr>
                        <tr>
                          <td class="email-menu-avatar"><img src="img/avatars/5.png" class="img-responsive" alt="avatar" /></td>
                          <td class="email-menu-message"><b>胡立亮</b><br />
                            百度管家，啥玩意，金币那么少，不干！</td>
                          <td class="email-menu-date"> 05/14/13 </td>
                        </tr>
                        <tr>
                          <td class="email-menu-avatar"><img src="img/avatars/3.png" class="img-responsive" alt="avatar" /></td>
                          <td class="email-menu-message"><b>沈健</b><br />
                            楼上正解....</td>
                          <td class="email-menu-date"> 05/14/13 </td>
                        </tr>
                        <tr>
                          <td class="email-menu-avatar"><img src="img/avatars/7.png" class="img-responsive" alt="avatar" /></td>
                          <td class="email-menu-message"><b>方志晗</b><br />
                            我完成了任务，快来膜拜我</td>
                          <td class="email-menu-date"> 05/14/13 </td>
                        </tr>
                        <tr>
                          <td class="email-menu-avatar"><img src="img/avatars/1.png" class="img-responsive" alt="avatar" /></td>
                          <td class="email-menu-message"><b>路捷</b><br />
                            这不是很简单的东西嘛~得瑟！</td>
                          <td class="email-menu-date"> 05/14/13 </td>
                        </tr>
                      </tbody>
            ...
            <div class="col-md-12">
              <div class="panel">
                <div class="panel-heading">
                  ...
                  <div class="panel-title visible-lg"> <i class="fa fa-info-circle"></i> 任务状态 <i class="fa fa-circle text-green"></i></div>
                ...
                <div class="panel-body">
                  <div class="email-content">
                    ...
                    <h1 class="email-subject">百度云管家</h1>
                    <div class="email-from padding-bottom"><span class="label label-success">发布者：程冉</span><span class="email-date padding-left">05/17/13 17:00</span></div>
                    <div class="email-to padding-bottom-sm">公司：百度公司 </div>
                    <div class="email-message">
                    <h3 class="text-primary">任务奖励：</h3>
                      	
                        <h3><span class="glyphicons glyphicons-coins text-yellow2"> 200分</span></h3>
                    	<h3 class="text-primary">任务介绍：</h3>
                      <p>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est, ipsam, in, consectetur, <b>ecusandae qui</b> ducimus fugit nam sint officia expedita illo voluptatem consequuntur Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laudantium, fugit, laboriosam, ipsam, doloribus iste officiiseveniet nisi maxime minima deserunt <b>cumque amet eos quos! Provident, natus, officia, </b> fuga eum harum ut quisquam in consequatur tempore tempora unde a consequuntur nisi sequi enim repellat delectus obcaecati laborum dignissimos quam quibusdam perferendis? distinctio tempora officiis adipisci impedit similique. Obcaecati.</p>
                      
                      <h3 class="text-primary">任务链接：</h3>
                      <p class="alert alert-info"><a href="#">www.baidu.com</a>
                      </p>
                      
                      
                      
                      <hr></hr>
                      <div class="text-right"><button class="btn btn-danger btn-gradient btn-lg" type="button">关闭当前任务</button></div>
