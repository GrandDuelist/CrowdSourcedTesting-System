        ...
        <div class="col-md-12">
          <div class="panel panel-visible">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-table"></i> 招募信息列表</div>
            </div>
            <div class="panel-body">
              <table class="table table-striped" id="datatable">
             	...
             	%>
                          ...
                          <td class="info"><b><%=recruitment.getActivityName()%></b><br />
                            <span class="text-muted"><i class="fa fa-home"></i><%=recruitment.getCompany()%></span></td>
