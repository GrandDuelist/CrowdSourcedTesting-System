...
<div class="container">		
	<div class="row-fluid">
        <form  action="manage.do?method=manage" class="log-page" method="post" >
        <h3>帐号登录
        <%if(session.getAttribute("a_login")!=null&&session.getAttribute("a_login").equals("fail")){
        session.setAttribute("a_login", null);
        session.removeAttribute("a_login");
        %>
