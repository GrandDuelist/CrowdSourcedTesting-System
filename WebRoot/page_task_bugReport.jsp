		...
		<div class="container">
			...
			<div class="logo">
				<a href="index.html"><img id="logo-header"
					src="assets/img/logo2-default.png" alt="Logo" />
				</a>
			</div>
			<!-- /logo -->
			<!-- Menu -->
	...
	<div class="breadcrumbs margin-bottom-40">
		<div class="container">
			...
			<ul class="pull-right breadcrumb">
				...
				<li class="active"><a href=""><%=testTask.getProduct().getProductName()%></a> <span class="divider">/</span>
				</li>
			</ul>
		</div>
		<!--/container-->
			...
			<div class="span9">
				<div class="blog margin-bottom-30">
					...
					<div class="post-comment">
						...
						<form enctype="multipart/form-data" action="testTaskDetailView.do"
							method="post">
							<input type="hidden" name="method" value="bugReportSubmit" /> <input
								type="hidden" name="taskID" value="<%=testTask.getTaskId()%>" />
							<%
								String value = (String) session
										.getAttribute("BugReportPublishErrorMessage");
							...
							%>
							<label>标题<span class="color-red">*</span>
							</label> <input type="text" name="bugTitle" required class="span7" /> <label>图片</label>
							<input type="file" name="bugImage" class="span7" /> <br /> <label>操作步骤<span
								class="color-red">*</span>
							</label>
							<textarea required name="bugOperation" rows="8" class="span10"></textarea>
							<label>操作结果<span class="color-red">*</span>
							</label>
			...
			<div class="row-fluid">
				...
				<div class="span4">
					<a href="index.html"><img id="logo-footer"
						src="assets/img/logo2-default.png" class="pull-right" alt="" />
					</a>
				</div>
			</div>
			<!--/row-fluid-->
